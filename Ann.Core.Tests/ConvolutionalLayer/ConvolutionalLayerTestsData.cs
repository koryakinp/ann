...
namespace Ann.Core.Tests.ConvolutionalLayer
{
    public class ConvolutionalLayerTestsData
    {
        ...
        static ConvolutionalLayerTestsData()
        {
            ...
            {
                ArrayConverter.Convert1Dto3D(
                    new double[] { -1.4574,-0.1856,-1.5417,-2.7487,0.1358,0.5103,-0.7852,-0.009,-1.3394,0.2747,1.022,2.0892,2.3004,0.5372,1.183,0.5305,0.5594,1.4385,0.0073,-0.6458,0.1677,0.1161,-1.2415,-1.0823,-1.0395,-2.252,-0.6967 },
                    new int[] { 3,3,3 }),
                ArrayConverter.Convert1Dto3D(
                    new double[] { 3.7756,1.6337,-1.005,-3.3437,0.1739,-1.1548,-1.0367,0.32,0.8643,-2.8974,2.7195,-0.4271,1.353,0.7564,1.3113,2.3082,0.9164,-1.4157,0.9108,-0.6791,-0.755,2.0249,0.0527,-1.0925,-2.1145,4.4376,-1.3643 },
                    new int[] { 3,3,3 }),
                ArrayConverter.Convert1Dto3D(
                    new double[] { 3.0615,-1.3893,1.2661,4.5089,1.7905,0.5675,3.9037,1.5069,2.1706,3.3825,1.2588,-3.6594,0.9354,-0.3211,0.0679,-2.0284,-0.7559,-0.9291,-1.2063,0.2261,-0.756,-0.8191,0.1753,-1.7506,2.3468,-1.6476,0.2252 },
                    new int[] { 3,3,3 }),
            };
        }
