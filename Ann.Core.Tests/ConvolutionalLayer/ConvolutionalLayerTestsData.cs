...
namespace Ann.Core.Tests.ConvolutionalLayer
{
    public class ConvolutionalLayerTestsData
    {
        ...
        static ConvolutionalLayerTestsData()
        {
            ...
            {
                new double[4][,,] {
                    ArrayConverter.Convert1Dto3D(new double[] { -1.3159,-1.4339,-1.1298,-2.5428,-0.9913,-0.7722,-1.341,-0.5662,0.5339,0.1306,1.9711,1.8432,0.9144,-0.066,0.5592,-0.1971,-0.3242,1.1532,-0.302,0.9279,0.2435,-0.1971,-0.8419,-1.514,-1.2448,-1.8497,-1.2657 }, new int[] { 3,3,3 }),
